            ...
            <div className="bg-white p-8 rounded shadow-md w-96">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input type="text" value={staffId} onChange={(e) => setStaffId(e.target.value)} className="w-full border p-2" required />
                    </div>
                    <div>
                        <label className="block">Class Name:</label>
                        <input type="text" value={className} onChange={(e) => setClassName(e.target.value)} className="w-full border p-2" required />
                    </div>
                    <div>
                ...
                <div className="mt-4 text-center">
                    <Link to="/" className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-2 px-4 rounded">
                        Go to Home
                    </Link>
                </div>
            </div>
